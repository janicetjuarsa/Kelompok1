...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Simpan ke tabel
    $stmt = $conn->prepare("INSERT INTO reservations (cafe_name, seat_number, time_from, time_to, created_at) VALUES (?, ?, ?, ?, NOW())");
    $stmt->bind_param("ssss", $cafe, $seat, $timeFrom, $timeTo);
